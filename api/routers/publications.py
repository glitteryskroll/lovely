...
from api.crud.publications_repository import get_posts, get_post, delete_post, edit_post, report_post, add_post_like
...
# Пример модели для хранения публикаций
class PublicationModel:
    def __init__(self, title: str, content: str, media: List[str], paid: bool = False):
        self.title = title
